...
//     }
//     // const postArticle = (e) => {
//     //     console.log("postedthere")
//     //     e.preventDefault();
//     //     if (e.traget !== e.currentTarget) {
//     //         console.log("posted")
//     //         return;
//     //     }
//     //     const payload = {
...
//     const postArticle = async (e) => { // Make the function asynchronous
//         console.log("postedthere");
//         e.preventDefault();
...
//         try {
//             await props.postArticle(payload); // Wait for the asynchronous action to complete
//             // console.log("posting pending");
//             // if (reset) {
//             //     reset(e);
//             // }
...
//                                 Creating a post
//                             </h2>
//                             <button onClick={(event) => reset(event)} > <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-x" viewBox="0 0 16 16">
...
const navigate=useNavigate();
    ...
    const postArticle = async (e) => {
        ...
        if (!editorText || (!shareImage && !videoLink)) {
            alert("Please provide a description and an image or video link.");
            return;
        }
        ...
        try {
            ...
            reset(e);
            // props.showModel("close")
            // alert("succeefull sended your firebase")
            navigate("/home")
        } catch (error) {
            console.error("Error posting article:", error);
        }
